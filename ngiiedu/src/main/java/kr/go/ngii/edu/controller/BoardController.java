...
public class BoardController extends BaseController {
	...
	public @ResponseBody ResponseEntity<ResponseData> insertFAQuestion(
		...
		BbsFAQuestion result = boardService.insertFaq(title, description);
		return new ResponseEntity<ResponseData>(responseBody(result), HttpStatus.OK);
	}
	...
	public @ResponseBody ResponseEntity<ResponseData> insertQuestion(
		...
		BbsQuestion result = boardService.insertQna(title, description);
		return new ResponseEntity<ResponseData>(responseBody(result), HttpStatus.OK);
	}
	...
	public @ResponseBody ResponseEntity<ResponseData> insertReply(
		...
		BbsReply result = boardService.insertRe(qnaId, description);
		return new ResponseEntity<ResponseData>(responseBody(result), HttpStatus.OK);
	}
	...
	public @ResponseBody ResponseEntity<InputStreamResource> getPdsFile(
		...
		StringBuffer fileName = new StringBuffer().append(bbsPdsFile.getFilePath()).append(".").append(bbsPdsFile.getExt());
		...
		responseHeaders.set("Content-Disposition", "attachment;filename=" + encordedFilename + ";filename*= UTF-8''" + encordedFilename);
