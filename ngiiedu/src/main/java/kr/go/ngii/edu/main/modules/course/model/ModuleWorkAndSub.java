 ...
 * 
 */
@XmlRootElement(name = "moduleWorkAndSub")
public class ModuleWorkAndSub implements Serializable {
	/** serialVersionUID. */
	...
	/** model_work_sub */
	private List<ModuleWorkSub> moduleWorkSubList;
	...
	public List<ModuleWorkSub> getModuleWorkSubList() {
		return moduleWorkSubList;
	}

	public void setModuleWorkSubList(List<ModuleWorkSub> moduleWorkSubList) {
		this.moduleWorkSubList = moduleWorkSubList;
	}
